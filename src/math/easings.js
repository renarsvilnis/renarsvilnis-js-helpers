...
export function easeInElastic (t) { return (0.04 - 0.04 / t) * Math.sin(25 * t) + 1; }

 // elastic bounce effect at the end
export function easeOutElastic (t) { return 0.04 * t / (--t) * Math.sin(25 * t); }

 // elastic bounce effect at the beginning and end
export function easeInOutElastic (t) { return (t -= 0.5) < 0 ? (0.01 + 0.01 / t) * Math.sin(50 * t) : (0.02 - 0.01 / t) * Math.sin(50 * t) + 1; }
